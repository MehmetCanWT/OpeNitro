# OpeNitro Support Guide for Acer Nitro 17 (AN17-41)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro 17 (AN17-41)** series when running **OpeNitro**.

# OpeNitro Support Guide for Predator Helios 16/18

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Predator Helios 16/18** series when running **OpeNitro**.
...
| **RGB Keyboard Backlight** | **🟢 Yes** | 🟢 Yes (Per-key / Multi-zone WMI RGB). |

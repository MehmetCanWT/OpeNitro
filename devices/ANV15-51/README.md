# OpeNitro Support Guide for Acer Nitro V 15 (ANV15-51)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro V 15 (ANV15-51)** series when running **OpeNitro**.
...
| **RGB Keyboard Backlight** | **🟢 Yes** | 🟢 Yes (RGB / Single-Color WMI support). |

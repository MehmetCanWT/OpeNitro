# OpeNitro Support Guide for Predator Helios 300

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Predator Helios 300** series when running **OpeNitro**.
...
| **RGB Keyboard Backlight** | **🟢 Yes** | 🟢 Yes (Multi-zone RGB via WMI facer module). |

---

## 🔍 Model-Specific Notes

*   **EC Register Layout:** Compatible base ACPI and EC mappings.

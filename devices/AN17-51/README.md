# OpeNitro Support Guide for Acer Nitro 17 (AN17-51)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro 17 (AN17-51)** series when running **OpeNitro**.

# OpeNitro Support Guide for Acer Nitro 5 (AN515-45)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro 5 (AN515-45)** series when running **OpeNitro**.

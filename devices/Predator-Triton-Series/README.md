# OpeNitro Support Guide for Predator Triton Series

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Predator Triton Series** series when running **OpeNitro**.
...
| **RGB Keyboard Backlight** | **🟢 Yes** | 🟢 Yes (WMI RGB supported). |

---

## 🔍 Model-Specific Notes

*   **EC Register Layout:** Experimental fan control, shares ACPI charging offsets.

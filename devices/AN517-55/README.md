# OpeNitro Support Guide for Acer Nitro 5 (AN517-55)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro 5 (AN517-55)** series when running **OpeNitro**.

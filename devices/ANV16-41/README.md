# OpeNitro Support Guide for Acer Nitro V 16 (ANV16-41)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro V 16 (ANV16-41)** series when running **OpeNitro**.

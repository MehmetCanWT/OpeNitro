# OpeNitro Support Guide for Acer Nitro 16 (AN16-43)

This guide contains compatibility details, specific Embedded Controller (EC) register mappings, and usage instructions for the **Acer Nitro 16 (AN16-43)** series when running **OpeNitro**.
